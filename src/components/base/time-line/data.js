    ...
    top: [
        {
            ...
            body: "Development and testing of the smart contract, this stage is focused on developing and testing the features and missions of the bridge's smart contract, it will focus on flow of events, security, consensus, voting mechanisms, gas efficiency, and interaction with transferred tokens smart contracts."
        }, {
        }, {
            title: '2021 Q3',
            subtitle: 'Testing',
            body: "Following stages I and II the Bridge will undergo heavy experiments to test security, scalability and flexibility. This stage will most likely be the longest as it is most essential to track down and fix any bugs or issues that might be present, as well as test and push scalability to it's best, to offer a finalized secure and efficient product to the crypto and blockchain community."
        }, {
        }, {
            title: '2022 Q1',
    ...
    bottom: [
        {
            ...
            body: "Data gathered from testing will be used to further improve the bridge and release public testing with the help of early node operators from partnered blockchains. This will allow users and developers to get familiar with the bridge prior to mainnet release."
        }, {
        }, {
            title: '2022 Q2',
