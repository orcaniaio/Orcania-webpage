          ...
          <div className="container px-3" style={{ zIndex: "10" }}>
            <div className="columns ">
              ...
              <div className="column is-1-desktop has-text-centered">
                <a
                  href="https://youtu.be/APl2u2iqmQE"
            ...
            <div className="container">
              <div className="columns">
                <div className="column" data-aos="fade-up">
                  ...
                  <p className="has-text-light  has-text-distriute is-size-5">
                    ...
                    <br />
                    <br />
                    The bridge is decentralized, it is run and secured by
                    hundreds of nodes that forward its transactions and prevent
                    any cheating, it is permissionless and anyone can add their
                    assets to it and develop on it, it's flexible and allows
                    developers to link any kind of assets and smart contrats to
                    it and even utilize the bridge for custom tasks by
                    customizing the contracts they link to it, the bridge is
                    ...
                    transaction fee, and thanks to the technology of the Crypto
                    Family, transactions on the Bridge are even cheaper than an
              ...
              <div className="columns is-reverse is-vcentered">
                ...
                <div className="column" data-aos="fade-up">
                  ...
                  <p className="has-text-light  has-text-distriute is-size-5">
                    The bridge was built to be secure, decentralized,
                    permissionless, cheap, and fast, it achieves that by
                    operating on the blockchains it links and through hundreds
                    of validator nodes that help run and secure the bridge.
                    <br />
                    <br />
                    The bridge is run and secured by hundreds of validator nodes
                    that process its transactions and prevent any cheating. The
                    nodes take care of carrying transactions from one blockchain
                    to another, they are what manages CFR-POS consensus, blocks,
                    epochs, authenticity, and the minting and burning of tokens
                    on the blockchains through submission of validated blocks.
                    <br />
                    <br />
              ...
              <div className="columns ">
                <div className="column" data-aos="fade-up">
                  ...
                  <p className="has-text-light  has-text-distriute is-size-5">
                    The Crypto Family Bridge is developer friendly and very
                    flexible, it allows developers to go crazy with it.
                    <br />
                    <br />
                    The bridge interacts with certain functions on the smart
                    contracts linked to it. By customizing the content of these
                    ...
                    will be provided for this in the future 'Crypto Family
                    Bridge V2.0').
                    <br />
                    <br />
                    ...
                    comming are cross chain NFT games, cross chain NFT
                    marketplaces, cross chain DEX's and a cross chain DEFI
                    ecosystems.
                  </p>
                </div>
                <div className="column has-text-centered" data-aos="fade-right">
              ...
              <div className="columns is-reverse">
                ...
                <div className="column" data-aos="fade-up">
                  ...
                  <p className="has-text-light  has-text-distriute is-size-5">
                    The Crypto Family Bridge is optimized for optimal
                    performance and the lowest of fees, and thanks to the
                    bridge's Beacon Block Protocol and Shared Processing
                    Protocol aka reverse congestive architecture, a transfer
                    using the bridge costs less than an ERC20 token transfer on
                    the blockchain, making the bridge very cheap even on
                    blockchains such as Ethereum.
                    <br />
                    <br />
                    The transcation fee of the bridge is payed with the bridges
                    governance coin CFC (Crypto Family Coin), this fee is payed
                    to validator, signer and claimer nodes to cover their
                    expenses. In the case of custom contracts an extra fee might
                    be needed for claimer nodes to cover their expenses and get
                    the transaction finalized.
                    <br />
                    <br />
                    The reverse congestive architecture of the bridge means that
                    the more transactions that the bridge has to process, the
                    cheaper it becomes to process these transactions, thus
        ...
        <div className="hero-body pb-6" style={{ overflow: "hidden" }}>
          <div className="container px-3">
            ...
            >
              ...
              <p className="has-text-light is-size-5">
                The Crypto Family Bridge aims at linking more suitable
                blockchains that can help build a proper multichain
                infrastructure.
                <br />
