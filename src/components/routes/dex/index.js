          ...
          <div className="block">
            <div className="container">
              ...
              <div className="columns is-reverse">
                ...
                <div className="column" data-aos="fade-up">
                  <h1 className="title has-line-text contrast is-3 has-text-contrast has-text-centered">
                    CF Expanding Liquidity Protocol
                  </h1>
                  <p className="has-text-light  has-text-distriute is-size-5">
          ...
          <div className="container px-3">
            ...
            >
              ...
              <p className="has-text-light is-size-5">
                On the CF-DEX there is CFC is in the middle of all swaps,
                meaning if a user provides ONE-CFC liquidity, then no matter
                what tokens the traders use to buy ONE or when traders use ONE
                to buy other cryptos, the user providing ONE-CFC liquidity is
