            ...
            <div className="container">
              <div className="columns">
                <div className="column" data-aos="fade-up">
                  ...
                  <p className="has-text-light  has-text-distriute is-size-5">
                    ...
                    options a user can pick from and mix to better secure and
                    manage their funds.
                  </p>
                </div>
              ...
              <div className="columns is-reverse">
                ...
                <div className="column" data-aos="fade-up">
                  ...
                  <p className="has-text-light  has-text-distriute is-size-5">
                    The Vault is still early in development and it's hard to
                    tell what will be coming on release.
                    <br />
                    <br />
                    Some of the security features currently confirmed are:
                    passwords, multiple password security, guards protocol.
                  </p>
                </div>
              </div>
              <br />
              ...
              <div className="columns ">
                <div className="column" data-aos="fade-up">
                  ...
                  <p className="has-text-light  has-text-distriute is-size-5">
                    ...
                    <br />
                    <br />
                    Some of the management features currently confirmed are:
                    allowance clearance, funds locking, multiple transfers,
                    smart contracts allowance through the vault.
                  </p>
                </div>
                <div className="column has-text-centered" data-aos="fade-right">
          ...
          <div className="container px-3">
            ...
            >
              <h1 className="title is-4 has-text-light-purple">
                What is the release date of the Vault ?
              </h1>
              <p className="has-text-light  has-text-distriute is-size-5">
                Release date is still not announced.
                <br />
            ...
            >
              <h1 className="title is-4 has-text-light-purple">
                What blockchains will the Vault be available on ?
              </h1>
              <p className="has-text-light  has-text-distriute is-size-5">
            ...
            >
              <h1 className="title is-4 has-text-light-purple">
                What assets will the Vault help secure ?
              </h1>
              <p className="has-text-light is-size-5">
                The vault will be focused on supporting and securing ERC20
                tokens and ERC721, ERC1155 NFTs.
              </p>
            </div>
          </div>
        </div>
