...
function NavBar() {
    ...
    return (
        <nav
            ...
            } has-background-primary py is-fixed-top custom-navbar ${isTransparent ? 'transparent' : 'has-shadow'} ${
        ...
        >
            <div className="container">
                ...
                <div id="navbar" className={`navbar-menu has-background-primary-mobile`}>
                    <div className="navbar-end">
                        <Link
                            to="/"
                            className={`navbar-item has-text-light  ${location.pathname === '/' ? 'is-active' : ''}`}
            ...
            >
              ...
              <h1>Wallet</h1>
                        ...
                        <Link
                            to="/dex"
                            className={`navbar-item has-text-light  ${location.pathname === '/dex' ? 'is-active' : ''}`}
                            onClick={onBurgerIClicked}
                        >
                            <span className="icon">
                        ...
                        <Link
                            to="/mint"
                            className={`navbar-item has-text-light  ${
                                location.pathname === '/mint' ? 'is-active' : ''
                            }`}
                            onClick={onBurgerIClicked}
                        >
                            <span className="icon">
