...
const Footer = () => {
    ...
    return(
        <footer className={`footer has-background-light py-6 ${location.pathname == '/app' ? 'is-hidden' : ''}`}>
                    ...
                    <div className="is-size-5 py-0 mb-0">
                        <div className="columns is-reverse py-0 footer-logo2">
                            ...
                            <div className="column has-text-centered-mobile" style={{}}>
                                <h1 className="title has-text-white mb-6 has-line-text-right primary is-3"> <strong className="has-text-primary">Crypto Family</strong></h1>
                                <h1 className="subtitle has-text-dark is-5">© Copyright Crypto Family. All Rights Reserved</h1>


                                <a href="https://twitter.com/cryptofamily3?lang=es" target="_blank" rel="noreferrer">
                                    <span className="icon has-text-dark is-size-3"><i className="fab fa-twitter"></i></span>
                                </a>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="https://discord.com/invite/XQSGzkC" target="_blank" rel="noreferrer">
