const Data = [
  {
    ...
    description: () => {
      <p className="has-text-light  has-text-distriute is-size-5">
        ...
        <br />
        <br />
        Our goals are many but are always focused on one concept... Building a
        better future for blockchain technology.
      </p>;
    },
  },
  {
    ...
    description: () => {
      <p className="has-text-light  has-text-distribute is-size-5">
        ...
        new protocols, and new ideas with a vast range of features, options, and
        environments. We also focus on improving some of the current protocols
        available or even replace them with more efficient ones.
        &nbsp;&nbsp;&nbsp;&nbsp;
      </p>;
    },
  },
